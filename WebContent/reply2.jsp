...
<title>complaince form for students</title>
<style> 
...
%>
<pre><h1>complaince form for students</h1></pre>
<form action="edituser2.jsp" method="post">
<input type="hidden" name="id" value="<%=u.getId() %>"/>
<input type="hidden" name="reply" value="<%=u.getreply() %>"/>
<input type="hidden" name="sex" value="<%=u.getSex() %>"/>
<table>
<tr><td> <pre>Please fill complaince form:</pre></td><td><input type="text" size="100"  name="country" value="<%= u.getCountry()%>"/></td></tr>
